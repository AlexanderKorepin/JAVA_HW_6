...
public class zadacha {
    ...
    public static Map<Integer, String> customer_choice_method(){
        ...
        while(proccess == true){   
            ...
            System.out.println("0: выйти и показать варианты ");
            ...
            if (choice == 1){
                ...
                System.out.print("Введите  2 или 4 или 8 или 16: ");
                ...
                System.out.print("Введите 256 или 512 или 1024 или 2048: ");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ноутбуки, которые удовлетворяют критериям поиска:");
        System.out.println();
